...
var LOCALES = ["pt", "en"];
function resolveLocale(flattenedPath) {
  const locale = flattenedPath.split("/")[1];
  return LOCALES.includes(locale) ? locale : "pt";
}
function resolveLocalizedSlug(flattenedPath) {
...
var Testimonial = defineDocumentType(() => ({
  name: "Testimonial",
...
var Presentation = defineDocumentType(() => ({
  name: "Presentation",
...
//# sourceMappingURL=compiled-contentlayer-config-MOUVPAWB.mjs.map
